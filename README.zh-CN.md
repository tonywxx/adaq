...
| [M8 Manual Acceptance](docs/m8-manual-acceptance.md) | [M8 人工验收](docs/m8-manual-acceptance.zh-CN.md) | 完整的 Model、Forecast Evaluation 与 Dataset-first Backtest 验收路径 |
