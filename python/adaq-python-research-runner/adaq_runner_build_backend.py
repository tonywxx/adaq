"""Stdlib-only deterministic wheel backend for the private Runner."""
...
NAME = "adaq_python_research_runner"
VERSION = "1.0.0"
...
def build_wheel(wheel_directory: str, config_settings: object = None, metadata_directory: str | None = None) -> str:
    ...
    payload = {
        "adaq_runner/__init__.py": (root / "src/adaq_runner/__init__.py").read_bytes(),
        "adaq_runner/__main__.py": (root / "src/adaq_runner/__main__.py").read_bytes(),
        f"{DIST_INFO}/METADATA": (
            "Metadata-Version: 2.3\nName: adaq-python-research-runner\n"
            "Version: 1.0.0\nRequires-Python: >=3.12,<3.13\n"
            "License-Expression: Apache-2.0\n\n"
        ).encode(),
        f"{DIST_INFO}/WHEEL": b"Wheel-Version: 1.0\nGenerator: adaq-managed-runner\nRoot-Is-Purelib: true\nTag: py3-none-any\n\n",
    }
    records = []
...
def build_sdist(*_args: object, **_kwargs: object) -> str:
    raise RuntimeError("ADAQ managed Runner is wheel-only")
