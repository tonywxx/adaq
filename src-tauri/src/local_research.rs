...
pub struct LocalDataSummary {
    ...
    pub(crate) watchlist_count: u64,
    pub(crate) component_count: u64,
    pub(crate) snapshot_count: u64,
    pub(crate) run_count: u64,
    pub(crate) protocol_count: u64,
    pub(crate) report_count: u64,
    pub(crate) generation_attempt_count: u64,
    pub(crate) model_artifact_count: u64,
    pub(crate) signal_dataset_count: u64,
