...
pub(super) fn run_report(
    ...
    for window in &protocol.windows {
        ...
        match (
            ...
            (Ok(sample_in_run), Ok(sample_out_run)) => windows.push(ValidationWindowReport {
                ...
                sample_in_start_time_ms: window.sample_in_start_time_ms,
                sample_in_end_time_ms: window.sample_in_end_time_ms,
    ...
    let mut report = ValidationReport {
        ...
        strategy_binding: protocol.strategy_binding,
        final_evidence_sealed: protocol.final_evidence_sealed,
...
fn run_cross_market(
    ...
    let mut report = ValidationReport {
        ...
        strategy_binding: protocol.strategy_binding.clone(),
        final_evidence_sealed: protocol.final_evidence_sealed,
        walk_forward: None,
