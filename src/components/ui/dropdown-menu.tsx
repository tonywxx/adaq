...
function DropdownMenuContent({
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Positioner className="z-50" sideOffset={sideOffset} align={align} side={side}>
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Positioner className="z-50" sideOffset={4}>
        <DropdownMenuPrimitive.Popup
