...
const english = {
	identifiers: {
		...
		canonicalData: "Canonical dataset",
		...
		candidateRevision: "Candidate revision fingerprint",
		...
		pythonEnvironment: "Python environment fingerprint",
		pythonRuntime: "Python runtime archive fingerprint (SHA-256)",
		pythonFile: "Project file fingerprint (SHA-256)",
...
const simplifiedChinese = {
	identifiers: {
		...
		pythonEnvironment: "Python 环境指纹",
		pythonRuntime: "Python 运行时压缩包指纹（SHA-256）",
		pythonFile: "项目文件指纹（SHA-256）",
		calendar: "交易日历快照",
	},
	app: {
