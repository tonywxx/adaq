...
const english = {
	...
	markets: {
		...
		dataFoundation: {
			...
			backfillSelected: "Selected instruments",
			backfillWatchlist: "Watchlist",
			backfillAll: "All live OKX instruments",
...
const simplifiedChinese = {
	...
	markets: {
		...
		dataFoundation: {
			...
			backfillScope: "回补范围",
			backfillSelected: "选择的交易标的",
			backfillWatchlist: "自选股",
			backfillAll: "全部有效 OKX 标的",
			...
			qualityWarning: "部分发布证据（Publication）需要检查后才能继续研究。",
