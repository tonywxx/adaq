...
const english = {
	...
	markets: {
		...
		dataFoundation: {
			...
			publicationEvidenceName: "Publication evidence name",
			publicationEvidenceNamePlaceholder: "Evidence name",
			...
			publishGateTwo: "Publish Gate 2",
			publishingGateTwo: "Publishing Gate 2…",
			gateTwoPublished: "Gate 2 published Point-in-Time Universe {{id}}",
			...
			assessQuality: "Assess Source quality",
			assessingQuality: "Assessing quality…",
			publicationCounts:
...
const simplifiedChinese = {
	...
	markets: {
		...
		dataFoundation: {
			...
			publicationEvidenceName: "发布证据名称",
			publicationEvidenceNamePlaceholder: "证据名称",
			publicationDescription: "选择用于研究之前，请检查每个已发布的数据集。",
			okxBackfillTitle: "OKX 现货 K 线（bars）",
			okxBackfillDescription:
				"获取所选范围，发布快照（Snapshot），并组建时点全市场数据集（Point-in-Time Universe）。",
			okxBackfillStart: "运行 OKX 回补",
			okxBackfillRunning: "回补运行中…",
			okxBackfillCancel: "取消回补",
			publishGateTwo: "发布 Gate 2 证据",
			publishingGateTwo: "正在发布 Gate 2…",
			gateTwoPublished: "Gate 2 已发布时点全市场数据集 {{id}}",
			backfillScope: "回补范围",
			...
			publishing: "发布中…",
			assessQuality: "评估来源质量",
			assessingQuality: "正在评估质量…",
			publicationCounts:
