...
const english = {
	identifiers: {
		...
		researchContext: "Research context fingerprint",
		operation: "Operation",
		featurePlan: "Feature plan fingerprint",
		featureDataset: "Feature dataset",
		factorDataset: "Factor dataset",
		signalDataset: "Signal dataset",
		definition: "Feature definition",
		definitionHash: "Feature definition fingerprint",
		attempt: "Research attempt",
		protocol: "Research protocol fingerprint",
		artifact: "Fitted artifact",
		fingerprint: "Content fingerprint (SHA-256)",
		archive: "Package archive fingerprint (SHA-256)",
		wasm: "Executable WASM fingerprint (SHA-256)",
		modelArtifact: "Model artifact fingerprint (SHA-256)",
		component: "Component",
		candidate: "Research candidate",
		factorDecision: "Factor promotion decision",
		qualification: "Qualification report",
		evaluationReport: "Forecast evaluation report",
		revision: "Revision fingerprint",
		wheelhouse: "Offline wheelhouse fingerprint",
		backtestRun: "Backtest run",
		validationReport: "Validation report",
		bot: "Paper trading bot",
		botAttempt: "Bot execution attempt",
		...
		entity: "Monitored entity",
		event: "Operational event",
		feedbackSnapshot: "Paper feedback snapshot",
		feedbackReport: "Paper feedback report",
		pythonProject: "Python research project",
		pythonRuntime: "Python runtime archive fingerprint (SHA-256)",
		calendar: "Trading calendar snapshot",
	},
	app: {
	...
	nav: {
		...
		research: "Research",
		simulationValidation: "Simulation & Validation",
		library: "Library",
		...
		paperExperiment: "Paper Experiment",
	...
	markets: {
		...
		dataFoundation: {
			...
			tabsLabel: "Data Foundation sections",
			sourceContentHash: "Stored evidence fingerprint (SHA-256)",
			sourcePayloadHash: "Source records fingerprint (SHA-256)",
			sourceAcquisitionHash: "Acquisition content fingerprint (SHA-256)",
			sourceResponseHash: "Upstream response {{number}} fingerprint (SHA-256)",
			sourceHashDescription:
				"Fingerprints verify stored evidence, source records, acquisition content, and each upstream response.",
			catalogFallbackName: "OKX instrument catalog",
			tabs: {
				overview: "Overview",
	...
	operations: {
		...
		systemDashboardEyebrow: "V1 system overview",
		systemDashboardTitle: "System Dashboard",
		systemDashboardDescription:
			"An authorized, rebuildable view of current Bot, Paper, research, and operational evidence.",
		systemDashboardUnavailable:
			"The global projection is unavailable; open Operations to inspect retained evidence.",
		openOperations: "Open Operations",
		systemStatusTitle: "System status",
		systemStatusDescription:
			"Gate 14 Health, unresolved Alerts, and recent operational state.",
		systemEvidenceDescription:
		...
		botSummaryDescription:
			"Current lifecycle, Attempt, decision, and recovery responsibility.",
		attemptsAndDecisions: "{{attempts}} Attempt(s) · {{decisions}} decision(s)",
		reconciliationRequired: "Reconciliation Required",
		noPaperAccount: "No OKX Demo Paper Account is retained.",
		openPaperTrading: "Open Paper Trading",
		paperSummaryTitle: "OKX Demo Paper Account",
		paperSummaryDescription:
			"Native-currency account and execution evidence; values are not cross-account totals.",
		currency: "Currency",
		cash: "Cash",
		...
		researchSummaryTitle: "Research evidence",
		researchSummaryDescription:
			"Retained evidence counts across the V1 research-to-Paper journey.",
		research: {
			watchlist: "Watchlist",
			snapshots: "Market snapshots",
			components: "Components",
			modelArtifacts: "Model artifacts",
			signalDatasets: "Signal datasets",
			...
			feedbackSnapshots: "Feedback snapshots",
			feedbackReports: "Feedback reports",
			reviewDecisions: "Review decisions",
		},
		paperOperations: "Paper operations",
		paperOperationsDescription:
			"Host-owned health, alert, safety-action, evidence, and notification views for paper operations.",
		planned: "Implemented · Gate 14",
		...
		dimensionFilter: "Filter by health dimension",
		...
		freezeStarted: "Freezing…",
		freezeCompleted:
			"Freeze All applied; new risk remains blocked pending recovery.",
		freezeFailed:
			"Freeze All could not be completed. The Host retained the safety action for retry.",
		recoverHost: "Recover Host Freeze All",
		recoverStarted: "Recovering…",
		recoverCompleted:
			"Host recovery was validated; the Freeze All condition is resolved.",
		recoverFailed:
			"Host recovery was not accepted. Reconcile the OKX Demo account and clear other safety conditions first.",
		probeUnavailable: "Live Host probes are temporarily unavailable.",
		loading: "Loading…",
		...
		firstCriticalEvent: "First Critical event",
		lastEvent: "Latest event",
		diagnostic: "Diagnostic",
		openEvidence: "Open owning evidence",
		noDiagnostic: "No diagnostic retained.",
	...
	paperExperiment: {
		eyebrow: "Gate 13 · supervised OKX Demo comparison",
		title: "Three-Instrument Paper Experiment",
		description:
			"Run BTC-USDT, ETH-USDT, and SOL-USDT with equal frozen capital and retain an auditable comparison report.",
		loading: "Loading experiment evidence…",
		unavailable: "Paper Experiment evidence is temporarily unavailable.",
		createTitle: "Configure experiment",
		createDescription:
			"Select one eligible Strategy Qualification per instrument, one verified OKX Demo account, and an explicit bounded UTC window.",
		connection: "OKX Demo connection",
		selectConnection: "Select a usable OKX Demo connection",
		account: "Account",
		qualification: "Strategy Qualification",
		selectQualification: "Select an eligible Strategy Qualification",
		invalidConfiguration:
			"Select one profile, three Strategy Qualifications, and a bounded UTC window.",
		observationStart: "Observation start (UTC)",
		observationEnd: "Observation end (UTC)",
		create: "Create experiment",
		creating: "Creating…",
		launch: "Refresh funds and launch",
		launching: "Launching…",
		refresh: "Refresh evidence",
		refreshing: "Refreshing…",
		stop: "Stop · Keep Position",
		stopping: "Stopping…",
		report: "Freeze comparison report",
		reporting: "Freezing…",
		...
		noExperiment: "No Paper Experiment is configured.",
		status: "Status",
		window: "Window",
		allocation: "Allocation",
		entryCap: "Entry cap",
		reservedCash: "Reserved headroom",
		unallocated: "Unallocated rounding remainder",
		bots: "Bots",
		...
		instrument: "Instrument",
		cash: "Attributed cash",
		position: "Position",
		price: "End price",
		equityReturn: "Net equity return",
		pnl: "Realized / unrealized PnL",
		fees: "Fees",
		trades: "Completed trades",
		exposure: "Exposure time",
		interruptions: "Interruptions",
		valuationCount: "Retained valuations",
		maxDrawdown: "Max drawdown",
		unmanagedPositions: "Unmanaged positions",
		evidence: "Evidence",
		rankingEligible: "Exact ranking eligible",
		rankingBlocked: "Exact ranking is blocked until evidence is complete.",
		bestInstrument: "Best observed instrument",
		rankingOrder: "Observed ranking",
		commonEndValuation: "Common end valuation",
		valuationCadence: "Valuation cadence",
		feedbackIds: "Feedback evidence IDs",
		feedbackSnapshots: "Feedback snapshot IDs",
		states: {
			draft: "Draft",
			preparing: "Preparing",
			armed: "Armed",
	...
	bots: {
		...
		emaDoubleCross: "EMA Double-Cross (15m Trade Events)",
	...
	factors: {
		...
		retry: "Retry",
		tabs: {
			families: "Discover Factors",
			candidates: "Candidates",
			datasets: "Datasets",
			evaluations: "Evaluate & Backtest",
			decisions: "Promote",
		},
		pagination: {
			previous: "Previous",
...
const simplifiedChinese = {
	identifiers: {
		...
		universe: "时点品种池快照",
		source: "来源证据",
		researchContext: "研究上下文指纹",
		operation: "操作记录",
		featurePlan: "特征计划指纹",
		featureDataset: "特征数据集",
		factorDataset: "因子数据集",
		signalDataset: "信号数据集",
		definition: "特征定义",
		definitionHash: "特征定义指纹",
		attempt: "研究尝试",
		protocol: "研究协议指纹",
		artifact: "拟合产物",
		fingerprint: "内容指纹（SHA-256）",
		archive: "组件压缩包指纹（SHA-256）",
		wasm: "WASM 执行文件指纹（SHA-256）",
		modelArtifact: "模型产物指纹（SHA-256）",
		component: "组件",
		candidate: "研究候选方案",
		factorDecision: "因子晋升决策",
		qualification: "资格评估报告",
		evaluationReport: "预测评估报告",
		revision: "修订指纹",
		wheelhouse: "离线 wheelhouse 指纹",
		backtestRun: "回测运行",
		...
		connection: "连接配置",
		account: "模拟交易账户",
		providerOrder: "交易服务订单",
		decision: "决策记录",
		related: "关联记录",
		entity: "监控对象",
		event: "运行事件",
		feedbackSnapshot: "模拟反馈快照",
		feedbackReport: "模拟反馈报告",
		pythonProject: "Python 研究项目",
		pythonRuntime: "Python 运行时压缩包指纹（SHA-256）",
		calendar: "交易日历快照",
	},
	app: {
	...
	nav: {
		...
		foundations: "基础准备",
		research: "研究",
		simulationValidation: "模拟与验证",
		library: "资源库",
		paperOperations: "纸面运营",
		marketsData: "市场与数据",
		dataFoundation: "数据基础",
	...
	markets: {
		...
		dataFoundation: {
			title: "数据基础",
			tabsLabel: "数据基础分区",
			sourceContentHash: "存储证据指纹（SHA-256）",
			sourcePayloadHash: "来源记录指纹（SHA-256）",
			sourceAcquisitionHash: "采集内容指纹（SHA-256）",
			sourceResponseHash: "上游响应 {{number}} 指纹（SHA-256）",
			sourceHashDescription:
				"指纹用于核验存储证据、来源记录、采集内容与每条上游响应。",
			catalogFallbackName: "OKX 品种目录",
			tabs: {
				overview: "概览",
				catalog: "品种目录",
				acquisition: "历史采集",
	...
	operations: {
		...
		systemDashboardEyebrow: "V1 系统总览",
		systemDashboardTitle: "系统仪表盘",
		systemDashboardDescription:
			"经授权、可重建的 Bot、模拟盘、研究与运行证据当前视图。",
		systemDashboardUnavailable:
			"全局投影暂时不可用；请打开运行面板查看已保留证据。",
		openOperations: "打开运行面板",
		systemStatusTitle: "系统状态",
		systemStatusDescription: "Gate 14 健康状态、未解决告警与最新运行状态。",
		systemEvidenceDescription:
		...
		openBots: "打开 Bot",
		botSummaryTitle: "Bot Runtime",
		botSummaryDescription: "当前生命周期、Attempt、决策与恢复责任。",
		attemptsAndDecisions: "{{attempts}} 个 Attempt · {{decisions}} 个决策",
		reconciliationRequired: "需要对账",
		noPaperAccount: "没有保留 OKX Demo 模拟账户。",
		openPaperTrading: "打开模拟交易",
		paperSummaryTitle: "OKX Demo 模拟账户",
		paperSummaryDescription:
			"按原生货币展示账户与执行证据；不会合并不同账户总额。",
		currency: "货币",
		cash: "现金",
		buyingPower: "可用购买力",
		reservedCash: "预留现金",
		...
		researchSummaryDescription: "V1 研究到模拟盘路径中已保留的证据数量。",
		research: {
			watchlist: "Watchlist",
			snapshots: "Market Snapshot",
			components: "Component",
			modelArtifacts: "Model Artifact",
			signalDatasets: "Signal Dataset",
			generationAttempts: "生成 Attempt",
			backtestRuns: "Backtest Run",
			validationProtocols: "Validation Protocol",
			validationReports: "Validation Report",
			feedbackSnapshots: "反馈 Snapshot",
			feedbackReports: "反馈 Report",
			reviewDecisions: "Review Decision",
		},
		paperOperations: "模拟运行",
		paperOperationsDescription:
			"由 Host 持有的模拟运行健康、告警、安全动作、证据与通知视图。",
		planned: "已实现 · Gate 14",
		marketSessions: "Market Sessions",
		...
		freezeStarted: "正在冻结…",
		freezeCompleted: "已执行全部冻结；恢复前新增风险仍被阻止。",
		freezeFailed: "全部冻结未完成。Host 已保留安全动作，可重试。",
		...
		correlationId: "关联 ID",
		firstEvent: "首次事件",
		firstCriticalEvent: "首次关键事件",
		lastEvent: "最新事件",
		diagnostic: "诊断信息",
		openEvidence: "打开所属证据",
		noDiagnostic: "没有保留诊断信息。",
		notAvailable: "不可用",
		occurrences: "{{count}} 次发生",
	...
	paperExperiment: {
		eyebrow: "Gate 13 · 监督的 OKX Demo 对比",
		title: "三标的模拟实验",
		description:
			"使用相同冻结资金运行 BTC-USDT、ETH-USDT、SOL-USDT，并保留可审计的对比 Report。",
		loading: "正在加载实验证据…",
		unavailable: "模拟实验证据暂时不可用。",
		createTitle: "配置实验",
		createDescription:
			"为每个标的选择一个可用的 Strategy Qualification、一个已验证 OKX Demo 账户，以及明确的有限 UTC 时间窗。",
		...
		entryCap: "入场上限",
		reservedCash: "预留资金余量",
		unallocated: "四舍五入未分配余数",
		bots: "Bots",
		runtimeAttempts: "Runtime Attempt 次数",
		warmup: "预热",
		warmupComplete: "已完成",
		warmupPending: "进行中",
		...
		exposure: "持仓暴露时间",
		interruptions: "中断次数",
		valuationCount: "保留估值次数",
		maxDrawdown: "最大回撤",
		unmanagedPositions: "未托管持仓",
		evidence: "证据",
		rankingEligible: "可进行精确排名",
		rankingBlocked: "证据完整前禁止精确排名。",
		bestInstrument: "观测到的最佳标的",
		rankingOrder: "观测排名",
		commonEndValuation: "共同结束估值",
		valuationCadence: "估值频率",
		feedbackIds: "反馈证据 ID",
		feedbackSnapshots: "反馈快照 ID",
		states: {
			draft: "草稿",
			preparing: "准备中",
			armed: "已武装",
	...
	bots: {
		...
		schedule: "决策调度",
		closedBar: "收盘 Bar",
		emaDoubleCross: "EMA 双均线交叉（15m Trade Event）",
